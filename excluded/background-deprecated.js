...
chrome.contextMenus.onClicked.addListener((info, tab) => {
    ...
    switch (info.menuItemId) {
        ...
        case "kbChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=$knowledge.do?sysparm_type_filter=all&sysparm_order=relevancy&query=' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "incChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=incident_list.do?sysparm_query=123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "ritmChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=sc_req_item_list.do?sysparm_query=123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "staskChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=sc_task_list.do?sysparm_query=123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "reqChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=sc_request_list.do?sysparm_query=123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "callChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=new_call_list.do?sysparm_query=123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "prbChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=problem_list.do?sysparm_query=123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "chgChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=change_request_list.do?sysparm_query=123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "secChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=u_security_inc_list.do?sysparm_query=123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "chatChild":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=chat_queue_entry_list.do?sysparm_query=%5EGOTO123TEXTQUERY321%3D' + encodedSelectedText, index: tab.index + 1
            });
        break;
        case "ipv4Child":
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=cmdb_ci_list.do?sysparm_query=ip_addressLIKE' + encodedSelectedText + '%5Esys_class_name%3Dcmdb_ci_computer', index: tab.index + 1
            });
        break;
        case "emailChild":
            chrome.tabs.create({
        ...
        case "teleChild":
          ...
          if(match){
            ...
            chrome.tabs.create({
                url: 'https://gsa.servicenowservices.com/nav_to.do?uri=sys_user_list.do?sysparm_query=phoneLIKE' + encodedSelectedText4Tele + '%5EORmobile_phoneLIKE' + encodedSelectedText4Tele + '%5EORhome_phoneLIKE' + encodedSelectedText4Tele, index: tab.index + 1
            });
        break;
        case "global":
            chrome.tabs.create({
